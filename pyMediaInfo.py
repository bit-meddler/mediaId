# forked (sort of) from https://github.com/sbraz/pymediainfo
# The default version doesn't play nicely on windows (no path to DLL)
# so added a minor cludge to force a path
...
class MediaInfo(object):
    ...
    PATH_TO_DLL = "" # modified to let us set the DLL path
    ...
    def _get_library():
        if os.name in ("nt", "dos", "os2", "ce"):
            return windll.LoadLibrary( os.path.join(MediaInfo.PATH_TO_DLL, "mediainfo.dll") )
